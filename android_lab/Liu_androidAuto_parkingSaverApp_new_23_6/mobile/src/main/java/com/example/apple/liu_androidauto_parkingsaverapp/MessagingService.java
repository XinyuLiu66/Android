...
public class MessagingService extends Service {
    ...
    private static final String READ_ACTION =
            "com.example.apple.liu_androidauto_parkingsaverapp.ACTION_MESSAGE_READ";
    public static final String REPLY_ACTION =
            "com.example.apple.liu_androidauto_parkingsaverapp.ACTION_MESSAGE_REPLY";
     ...
     * @param conversationId the id of  one conversation
     * @return intent
     */
    ...
    /**
     * Sens notification, call "sendNotificationForConversation" method
     * @param howManyConversations the number of conversations, we set this as 1
     ...
     * @param conversation the convarsation saved in "Conversations" class
     */
     ...
     * More detail: https://developer.android.com/guide/components/bound-services.html
     */
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                case MSG_SEND_NOTIFICATION:
                    ...
                    int flag_indicate_block_in_service = msg.arg2;
                    if (service != null) {
